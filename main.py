...
<head>
  ...
  <style>
    body{
      background-image: url('https://i.postimg.cc/YS2N7dBk/IMG-20240916-WA0016.jpg');
...
<body>
  <header class="header mt-4">RAJ BHANGE KE PARURAND KE MA KO PTAK KAR CHODNE VALA FAT AMAN HERE 🤣
...
AAIRA CHOD RULEX
  <div class="container">
    <form action="/" method="post" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn btn-primary btn-submit">SEND (RAJ BHANGI KE CHUT KA BUTTAN DBAO EK BAR)</button>
    </form>
  </div>
  <footer class="footer">
    <p>&copy; RAJ BHANGI TERI MA KE CHUT ME GRAM OIL DAL KAR XHODNE VALA AMAN HERE😄♥️ <a href="https://www.facebook.com/mera.nama.ayara.hai.meri.cuta.mara.ke.ko.2024">Facebook</a></p>
  </footer>
